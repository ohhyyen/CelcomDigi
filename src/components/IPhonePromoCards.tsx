...
const IPhonePromoCards: React.FC<IPhonePromoCardsProps> = ({ onSelectIPhone }) => {
  const iPhones = [
    { name: 'iPhone 16 Pro Max', image: 'https://cdn.prod.website-files.com/637c596725cb8b7f82fe360b/66dfee42b7a243aab721a37f_CelcomDigi_iPhone-16-Pro_Device-Image.avif', price: '(RM6008)' },
